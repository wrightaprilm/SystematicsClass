...
# Using your computer's graphical user interface


## Downloading and storing data and scripts
...
## Preparing to Run RevBayes

In this of the tutorial, we will focus on running RevBayes from your computer's graphical interface.
...
This is an example of the Macintosh File Viewer. In this instance, I have adirectory, `Tutorials` with a# directory for this specific tutorial.
...
```{r}
devtools::install_local("~/projects/RevKnitr/")
```

Next, we will launch RevBayes in RStudio. Start a new executeable chunk by typing the following:
...
Now, enter the path to your tutorial in the below parentheses:

```{rb}
setwd("~/Documents/Courses/Systematics2020/vignettes/01_tutorial_structure/")
...
# Using your computer's terminal interface
