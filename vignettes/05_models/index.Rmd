...
## Download data [here](revbayes.github.io/tutorials/ctmc/).
...
### Specific functions for substitution models available in RevBayes.
 ...
 | K80 (a.k.a. K2P) |    [@Kimura1980]    |      fnK80      |        $\kappa$         |
...
In the JC graphical model, the tree topology is denoted $\Psi$ and the 
...
Thus, it is important to use programs like [Tracer](http://tree.bio.ed.ac.uk/software/tracer/) [@Rambaut2011] to evaluate mixing and non-convergence.
...
-   With The JC graphical model as your guide, draw the probabilistic
...
(this represents the stochastic node for the $\alpha$-shape parameter in the GTR graphical model.
