...
1) How is the parsimony score impacted if you analysed more characters under our custom matrix (my_ctype)? Does this make sense to you? What happens if you try analyzing all characters under my_ctype? 

2) Compare and contrast the Jukes-Cantor model and an unweighted parsimony step matrix.


3) Let's say you have a dataset and want to analyze it under ML and parsimony. How can you compare the results? Can they be compared statistically? 

I am an arrogant jerk, and I would like you to [read a paper I have accepted](https://github.com/graemetlloyd/ProjectWhalehead/blob/master/vignettes/MS.pdf) right now. Write a note for me if any of my arguments in the paper change your mind on the above questions.
