...
Download the data from [here](https://revbayes.github.io/tutorials/morph_tree/). The data file is called Cinctans.nex.

**Getting Started**

>Create a new directory your RStudio called "DiscreteMorphologyLab."
...
library(convenience)
saveRev("scripts/mcmc_Morpho.Rev", use_quit=FALSE)
callRevFromTerminal("scripts/mcmc_Morpho.Rev")
