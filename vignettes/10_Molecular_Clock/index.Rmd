...
author: David F. Wright, with April Wright, Dave Bapst and Pete Wagner
output:
  html_document: 
    theme: spacelab
...
[The data are here](https://dwbapst.github.io/PaleoSoc_phylo_short_course_2019/articles/downloads.html)
...
```{rb}
    taxonData <- readTaxonData(file="cincta_fossil_intervals_FA.tsv")
```
